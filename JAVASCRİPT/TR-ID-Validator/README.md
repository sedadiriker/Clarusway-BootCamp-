...
Purpose of the this project is to write a code that given TR Identity Number, returns  valid or invalid.
...
[TR-ID-Validator Live Page](https://sedadiriker.github.io/Clarusway-BootCamp-/JAVASCR%C4%B0PT/TR-ID-Validator//)
